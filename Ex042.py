...
if r2 + r3 > r1 and r1 + r3 > r2 and r1 + r2 > r3:
    ...
    if r1 == r2 and r1 == r3:
        print('O triangulo criado sera um triangulo equilatero')
    elif r1 == r2 or r1 == r3 or r2 == r3:
        print('O triangulo criado sera um triangulo isosceles')
    elif r1 != r2 and r1 != r3 and r2 != r3:
        print('O triangulo criado sera um triangulo escaleno')
else:
